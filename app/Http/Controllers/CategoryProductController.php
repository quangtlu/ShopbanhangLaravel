...
//    Home
    public function get_product_by_category($category_id){
        ...
        $product = DB::table('tbl_product')->where('category_id', $category_id)->paginate(3);
        return view('pages.category.show_category')->with('product', $product)->with('category', $category)->with('categories', $cate_product)->with('brands', $brand_product);
    }
}
