...
class BrandProductController extends Controller
{
    ...
    public function get_product_by_brand($brand_id){
        ...
        $product = DB::table('tbl_product')->where('brand_id', $brand_id)->paginate(3);
        return view('pages.brand.show_brand')->with('product', $product)->with('brand', $brand)->with('categories', $cate_product)->with('brands', $brand_product);
    }
}
